...
[**Report a vulnerability**](https://github.com/hassio-addons/app-jupyterlab/security/advisories/new)
...
- Issues in JupyterLab itself; please report those directly to the
  [Jupyter project](https://github.com/jupyterlab/jupyterlab/security/policy).
...
- Code execution resulting from notebooks the user chooses to run. This app
  is an interactive programming environment; running arbitrary code is its
  purpose.
...
This security policy covers the JupyterLab Home Assistant app published from
